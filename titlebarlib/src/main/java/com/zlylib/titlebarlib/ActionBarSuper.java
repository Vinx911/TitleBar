...
public final class ActionBarSuper extends ActionBarEx {
    ...
    public void initTitleTextView() {
        ...
        FrameLayout.LayoutParams titleLayoutParams = (FrameLayout.LayoutParams) titleLayout.getLayoutParams();
    ...
    private void initLeftActionViews() {
        ...
        for (int i = 0; i < leftActionViews.length; i++) {
            ...
            if (leftTextClickToFinish[i]) {
                leftActionViews[i].getTextView().setOnClickListener(new View.OnClickListener() {
                    @Override
            ...
            if (leftIconClickToFinish[i]) {
                leftActionViews[i].getIconView().setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        finishActivity();
                    }
    ...
    private void initRightActionViews() {
        ...
        for (int i = 0; i < rightActionViews.length; i++) {
            ...
            if (rightTextClickToFinish[i]) {
                rightActionViews[i].getTextView().setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        finishActivity();
                    }
            ...
            if (rightIconClickToFinish[i]) {
                rightActionViews[i].getIconView().setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        finishActivity();
                    }
